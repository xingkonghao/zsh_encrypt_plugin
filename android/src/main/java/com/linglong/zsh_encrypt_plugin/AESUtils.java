package android.src.main.java.com.linglong.zsh_encrypt_plugin;
...
public class AESUtils {
	...
	public static byte[] parseHexStr2Byte(String hexStr) {
        ...
        //注意: 这里的password(秘钥必须是16位的),linglongdingdong
	public static final String keyBytes = UUID.randomUUID().toString().substring(0, 16);
